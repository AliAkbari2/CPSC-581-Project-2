...
public class Socket7Script : MonoBehaviour
{
            ...
            if (hit1.collider != null)
            {
                ...
                if (hit1.collider.transform.gameObject.layer == 3)
                {
                    if (inTheRightGO)
                    {
                        ...
                        if (hit1.collider.transform.gameObject.name == "End Point 2")
                        {
                            Socket8Script.thePassword += "s7";
                        }
                        else
                        {
                            Socket8Script.thePassword += "NOTs7";
                        }
                    }
                }
            }
