...
public class Socket6Script : MonoBehaviour
{
    ...
    void ConnectTheWire()
    {
        ...
        {
            startPos = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, 0);
            ...
            if (hit1.collider != null)
            {
                ...
                if (hit1.collider.transform.gameObject.layer == 3)
                {
                    if (inTheRightGO)
                    {
                        ...
                        if (hit1.collider.transform.gameObject.name == "End Point 3")
                        {
                            Socket8Script.thePassword += "s6";
                        }
                        else
                        {
                            Socket8Script.thePassword += "NOTs6";
                        }
                    }
                }
            }
