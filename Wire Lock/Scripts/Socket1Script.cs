...
public class Socket1Script : MonoBehaviour
{
            ...
            if (hit1.collider != null)
            {
                ...
                if (hit1.collider.transform.gameObject.layer == 3)
                {
                    if (inTheRightGO)
                    {
                        ...
                        if(hit1.collider.transform.gameObject.name == "End Point 1")
                        {
                            Socket8Script.thePassword += "s1";
                        }
                        else
                        {
                            Socket8Script.thePassword += "NOTs1";
                        }
                    }
                }
            }
