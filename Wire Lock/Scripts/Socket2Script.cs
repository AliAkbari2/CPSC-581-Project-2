...
public class Socket2Script : MonoBehaviour
{
            ...
            if (hit1.collider != null)
            {
                ...
                if (hit1.collider.transform.gameObject.layer == 3)
                {
                    if (inTheRightGO)
                    {
                        ...
                        if (hit1.collider.transform.gameObject.name == "End Point 4")
                        {
                            Socket8Script.thePassword += "s2";
                        }
                        else
                        {
                            Socket8Script.thePassword += "NOTs2";
                        }
                    }
                }
            }
